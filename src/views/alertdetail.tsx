...
import { Alert, allProps, DataRow, DisplayableAlertProperties, shortHeadline } from "../components/alerts";
...
export function AlertDetail() {
  ...
  return (
    ...
    <Grid container spacing={2}>
      ...
      {alert && allProps.map((property: DisplayableAlertProperties) => (
        <DataRow alert={alert} property={property} key={`display-${property}`} />
      ))}
    </Grid>
    </Container>
  );
